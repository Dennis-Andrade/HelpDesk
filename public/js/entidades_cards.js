(function(){
  ...
  const fields = {
    ...
    direccion: modal.querySelector('#ent-md-direccion'),
    ...
    facturacion: modal.querySelector('#ent-md-facturacion'),
    sic:         modal.querySelector('#ent-md-sic'),
    fecha:       modal.querySelector('#ent-md-fecha')
  };
  ...
  document.addEventListener('click', function(ev){
    ...
    fetchDetalle(id).then(function(data){
      ...
      setText(fields.direccion, data && data.direccion ? data.direccion : '—');
      ...
      setText(fields.facturacion, data && data.facturacion_total_formatted ? data.facturacion_total_formatted : '—');
      setText(fields.sic, data && data.sic_licencias_formatted ? data.sic_licencias_formatted : '—');
      setText(fields.fecha, data && data.fecha_registro_formatted ? data.fecha_registro_formatted : '—');
