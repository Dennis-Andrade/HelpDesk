...
$entidades = isset($entidades) && is_array($entidades) ? $entidades : [];
$toastData = isset($toast) && is_array($toast) ? $toast : null;

$exportFilters = $filters;
$exportFilters['q'] = $q ?? '';
$exportFilters = array_filter($exportFilters, static function ($value) {
    if (is_array($value)) {
...
$exportQuery = http_build_query($exportFilters, '', '&', PHP_QUERY_RFC3986);
...
<section class="ent-list" aria-labelledby="contactos-title">
  <?php if ($toastData && isset($toastData['message'])): ?>
    <div
      id="ent-toast"
      class="ent-toast"
      role="status"
  ...
  <section class="ent-container ent-contactos-list" aria-label="Contactos registrados">
    <form class="ent-search ent-search--stack ent-search--with-modal" action="/comercial/contactos" method="get" role="search">
      ...
      <div class="ent-search__actions ent-search__actions--downloads">
        <a class="btn btn-outline" href="/comercial/contactos/export/csv<?= h($exportSuffix) ?>">
          <span class="material-symbols-outlined" aria-hidden="true">table_rows</span>
          <span>Descargar CSV</span>
        </a>
        <a class="btn btn-outline" href="/comercial/contactos/export/vcf<?= h($exportSuffix) ?>">
  ...
  <div class="contact-modal__dialog" role="dialog" aria-modal="true" aria-labelledby="nuevo-contacto-modal-title" tabindex="-1" data-modal-dialog>
    ...
    <form method="post" action="/comercial/contactos" class="form ent-form contact-modal__form">
      ...
      <div class="form-row">
        ...
        <input id="modal-contacto-telefono" type="text" name="telefono" placeholder="0999999999" inputmode="numeric" pattern="[0-9]{7,10}" maxlength="10">
      </div>
      <div class="form-row">
  ...
  <div class="contact-modal__dialog" role="dialog" aria-modal="true" aria-labelledby="editar-contacto-modal-title" tabindex="-1" data-modal-dialog>
    ...
    <form method="post" action="" class="form ent-form contact-modal__form" data-contact-edit-form data-action-base="/comercial/contactos/">
      ...
      <div class="form-row">
        ...
        <input id="modal-editar-contacto-telefono" type="text" name="telefono" inputmode="numeric" pattern="[0-9]{7,10}" maxlength="10">
      </div>
      <div class="form-row">
