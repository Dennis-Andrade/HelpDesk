...
final class AgendaRepository extends BaseRepository
{
    ...
    {
        $sql = $this->baseSelect()
            . ' WHERE a.fecha_evento BETWEEN :desde AND :hasta'
            . ' ORDER BY a.fecha_evento ASC, a.titulo ASC';
        ...
        try {
            ...
            throw new RuntimeException('No se pudo obtener la agenda para el calendario unificado.', 0, $e);
        }
