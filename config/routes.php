...
$router->get('/comercial/agenda/{id}/editar',    [AgendaController::class, 'edit'],         ['middleware'=>['auth','role:comercial']]);
$router->post('/comercial/agenda/{id}/actualizar',[AgendaController::class, 'update'],      ['middleware'=>['auth','role:comercial']]);
